            ...
            $.post(`${hostname}/Home/ReadMore`,
                ...
                function (data) {
                    ...
                    for (var i = 0; i < dt.length; i++) {
                        ...
                        str += `       <b><a href="${hostname}/profile?id=` + dt[i].id +`"><span class="img-avatar"><img src="${hostname}/asset/images/avatar/`+dt[i].avatar+'" /></span></a><span>'+dt[i].nguoi_dang+` >></span><span><a href="/group/chitiet?ma_nhom=`+dt[i].ma_nhom+'"> '+dt[i].ten_nhom+'</a></span></b>';
                        str += ' </div>';
                        ...
                        for (var m = 0; m < dt[i].cmt.length; m++) {
                            ...
                            str += `                     <div class="img-avatar-comment "><a href="${hostname}/profile?id=` + dt[i].cmt[m].uid + `"><img src="${hostname}/asset/images/avatar/` + dt[i].cmt[m].avatar + '" /></a></div>';
